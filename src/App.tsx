...
import { Dogs as PlainReduxDogs } from './plain-redux/single-file';
import { Dogs as RTKQueryDogs } from './rtk-query/single-file';
import { Dogs as ReduxToolkitDogs } from './redux-toolkit/single-file';
